...
export default function Contacts() {
  return (
    <div className="mt-5 pt-5">
      <div className="mt-3">
        <h2 className="text-center text-info"><b>¡Mantengamónos en contacto!</b></h2>
      <div className=" d-flex text-center flex-wrap justify-content-around px-3 text-danger mt-5">
        ...
        <p className="mt-4 text-light">+503 6251-4584</p>
        </div>
        ...
        <h6 className="mt-4 text-light">HCRFRestaurant@gmail.com</h6>
        </div>
        <div>
        <h3 className="text-warning text-center mb-5">Redes</h3>
        <FontAwesomeIcon icon={faFacebook} size="3x"/>
        <h6 className="mt-4 mb-4 text-light">HCRFRestaurant sv</h6>
        <FontAwesomeIcon icon={faTwitter} size="3x px-2"/>
        <FontAwesomeIcon icon={faInstagram} size="3x"/>
        <h6 className="mt-4 mb-4 text-light">@HCRFRestaurant</h6>
        </div>
          </div>
      </div>
    </div>
